...
add_filter( 'woocommerce_package_rates', 'filter_rates_to_free_shipping', 10, 2 );

 function filter_rates_to_free_shipping( $rates, $package ) {
    if(MyProduct::isAlwayFreeShip()){
