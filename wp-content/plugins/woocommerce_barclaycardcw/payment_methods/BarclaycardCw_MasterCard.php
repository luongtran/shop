...
class BarclaycardCw_MasterCard extends BarclaycardCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_barclaycardcw_mastercard_icon', 
			BarclaycardCwUtil::getResourcesUrl('icons/mastercard.png')
		);
		parent::__construct();
	}
