...
class BarclaycardCw_AmericanExpress extends BarclaycardCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_barclaycardcw_americanexpress_icon', 
			BarclaycardCwUtil::getResourcesUrl('icons/americanexpress.png')
		);
		parent::__construct();
	}
