...
abstract class Customweb_Barclaycard_AbstractLineItemBuilder {
	...
	public function build() {
		...
		foreach ($this->getItems() as $item) {
			if ($this->isItemAllowedInList($item)) {
				$fields = $this->getLineItemFields($item);
	 ...
	 * @return array
	 */
	abstract protected function getLineItemFields(Customweb_Payment_Authorization_IInvoiceItem $item);
