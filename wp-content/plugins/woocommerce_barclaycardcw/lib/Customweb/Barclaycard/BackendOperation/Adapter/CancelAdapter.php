...
require_once 'Customweb/Barclaycard/BackendOperation/Adapter/CancelParameterBuilder.php';
 ...
 *
 */
class Customweb_Barclaycard_BackendOperation_Adapter_CancelAdapter extends Customweb_Barclaycard_AbstractAdapter 
	...
	public function cancel(Customweb_Payment_Authorization_ITransaction $transaction) {
		...
		$builder = new Customweb_Barclaycard_BackendOperation_Adapter_CancelParameterBuilder($transaction, $this->getContainer());
