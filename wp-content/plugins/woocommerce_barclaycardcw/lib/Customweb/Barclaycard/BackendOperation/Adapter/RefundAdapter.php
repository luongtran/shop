...
require_once 'Customweb/Barclaycard/BackendOperation/Adapter/RefundParameterBuilder.php';
 ...
 *
 */
class Customweb_Barclaycard_BackendOperation_Adapter_RefundAdapter extends Customweb_Barclaycard_AbstractAdapter 
	...
	public function partialRefund(Customweb_Payment_Authorization_ITransaction $transaction, $items, $close){
		...
		$builder = new Customweb_Barclaycard_BackendOperation_Adapter_RefundParameterBuilder($transaction, $this->getContainer(), $amount, $close);
