 ...
 * @Bean
 */
class Customweb_Barclaycard_Method_Factory extends Customweb_Payment_Authorization_Method_AbstractFactory{
	
	protected function getMethodPackages() {
		return array('Customweb_Barclaycard_Method');
	}
	
	/**
	 * @return Customweb_Barclaycard_Method_DefaultMethod
	 */
