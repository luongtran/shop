...
require_once 'Customweb/Barclaycard/Method/OpenInvoice/RatePay/LineItemBuilder.php';
 ...
 */
class Customweb_Barclaycard_Method_OpenInvoice_RatePay extends Customweb_Barclaycard_Method_OpenInvoice_Abstract {
	...
	public function getAuthorizationParameters(Customweb_Barclaycard_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_Barclaycard_Method_OpenInvoice_RatePay_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
	...
	protected function getBillingAddressParameters(Customweb_Barclaycard_Authorization_Transaction $transaction) {
		...
		$parameters['ECOM_BILLTO_POSTAL_NAME_FIRST'] = Customweb_Barclaycard_Util::substrUtf8($orderContext->getBillingFirstName(), 0, 35);
		$parameters['ECOM_BILLTO_POSTAL_NAME_LAST'] = Customweb_Barclaycard_Util::substrUtf8($orderContext->getBillingLastName(), 0, 35);
