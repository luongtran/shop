 ...
 */
class Customweb_Barclaycard_Method_OpenInvoice_PostFinanceFis_LineItemBuilder extends Customweb_Barclaycard_AbstractLineItemBuilder {
	
	protected function getLineItemFields(Customweb_Payment_Authorization_IInvoiceItem $item) {
		$fields = array();
		$fields['ITEMID'] = Customweb_Util_String::substrUtf8($this->sanatizeItemName($item->getOriginalSku()), 0, 10);
