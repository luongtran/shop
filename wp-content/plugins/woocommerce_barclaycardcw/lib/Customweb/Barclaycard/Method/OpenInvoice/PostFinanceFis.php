...
require_once 'Customweb/Barclaycard/Method/OpenInvoice/PostFinanceFis/LineItemBuilder.php';
 ...
 */
class Customweb_Barclaycard_Method_OpenInvoice_PostFinanceFis extends Customweb_Barclaycard_Method_OpenInvoice_Abstract {
	...
	public function getAuthorizationParameters(Customweb_Barclaycard_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_Barclaycard_Method_OpenInvoice_PostFinanceFis_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
...
// 			$parameters['OWNERTELNO'] = Customweb_Barclaycard_Util::substrUtf8($phoneNumber, 0, 30);
		}
		$mobile = $orderContext->getBillingMobilePhoneNumber();
		if (!empty($mobile)) {
// 			$parameters['OWNERTELNO2'] = Customweb_Barclaycard_Util::substrUtf8($orderContext->getBillingMobilePhoneNumber(), 0, 30);
		}
