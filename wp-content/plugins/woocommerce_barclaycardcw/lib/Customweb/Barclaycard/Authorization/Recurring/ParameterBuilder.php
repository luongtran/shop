...
require_once 'Customweb/Barclaycard/Authorization/AbstractAuthorizationParameterBuilder.php';


class Customweb_Barclaycard_Authorization_Recurring_ParameterBuilder extends Customweb_Barclaycard_Authorization_AbstractAuthorizationParameterBuilder
{
	...
	public function buildParameters() {
		...
		$parameters['ECI'] = Customweb_Barclaycard_IAdapter::ECI_REGULAR_RECURRING;
