...
require_once 'Customweb/Barclaycard/Authorization/Hidden/AliasGatewayParameterBuilder.php';
 ...
 *
 */
class Customweb_Barclaycard_Authorization_Hidden_Adapter extends Customweb_Barclaycard_Authorization_AbstractAdapter 
	...
	public function getHiddenFormFields(Customweb_Payment_Authorization_ITransaction $transaction) {
		$builder = new Customweb_Barclaycard_Authorization_Hidden_AliasGatewayParameterBuilder($transaction, $this->getContainer());
