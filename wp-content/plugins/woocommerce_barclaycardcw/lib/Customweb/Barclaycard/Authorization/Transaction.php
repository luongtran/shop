...
class Customweb_Barclaycard_Authorization_Transaction extends Customweb_Payment_Authorization_DefaultTransaction {
	...
	public function is3dRedirectionRequired() {
		...
		return $params['STATUS'] == Customweb_Barclaycard_IAdapter::STATUS_WAITING_FOR_IDENTIFICATION;
	}
