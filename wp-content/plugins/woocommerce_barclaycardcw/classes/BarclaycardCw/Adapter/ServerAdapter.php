...
library_load_class_by_name('Customweb_Form_Renderer');
require_once 'AbstractAdapter.php';

/**
 * @Bean
 */
class BarclaycardCw_Adapter_ServerAdapter extends BarclaycardCw_Adapter_AbstractAdapter
{
	...
	public function getCheckoutFormVaiables(BarclaycardCw_Transaction $dbTransaction, $failedTransaction) {
		...
		$formActionUrl = BarclaycardCwUtil::getPluginUrl("authorize.php", array('cw_transaction_id' => $dbTransaction->getTransactionExternalId()));
		$errorMessage= '';
	...
	public function getReviewFormFields(Customweb_Payment_Authorization_IOrderContext $orderContext, $aliasTransaction) {
		...
		return Customweb_Licensing_BarclaycardCw_License::run('m5o9etf9l3igpvun', $this, $arguments);
	}

	public function call_hlbgckvpidm7gqui() {
