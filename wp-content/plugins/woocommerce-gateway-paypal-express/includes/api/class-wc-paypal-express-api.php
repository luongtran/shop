...
class WC_Paypal_Express_API extends SV_WC_API_Base implements SV_WC_Payment_Gateway_API {
	...
	protected function do_post_parse_response_validation() {
		...
		if ( $this->get_response()->has_api_error() ) {
			...
			$message = sprintf( __( 'Code: %s, %s', WC_PayPal_Express::TEXT_DOMAIN ), $this->get_response()->get_api_error_code(), $this->get_response()->get_api_error_message() );
	...
	protected function get_plugin() {
		return $GLOBALS['wc_paypal_express'];
	}
