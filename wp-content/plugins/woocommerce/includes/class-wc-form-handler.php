...
class WC_Form_Handler {
	...
	public static function init() {
		...
		add_action( 'init', array( __CLASS__, 'process_registration' ) );
                add_action( 'init', array( __CLASS__, 'process_checkout_registration' ) );
                add_action( 'init', array( __CLASS__, 'process_checkout_delivery' ),20 );
        ...
        public static function process_checkout_delivery(){
            if(isset($_POST['checkout_delivery'])){
                ...
                WC()->checkout()->process_checkout_deliver();
            }
        }
	...
	public static function process_registration() {
        ...
        public static function process_checkout_registration() {
		if ( ! empty( $_POST['checkout_register'] ) ) {

			wp_verify_nonce( $_POST['checkout_register'], 'woocommerce-register' );
