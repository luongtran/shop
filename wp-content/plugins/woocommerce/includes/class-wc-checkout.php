...
class WC_Checkout {
	...
	public function get_value( $input ) {
        ...
        public function process_checkout_deliver() {
		if ( ! defined( 'WOOCOMMERCE_CHECKOUT' ) )
			define( 'WOOCOMMERCE_CHECKOUT', true );
		...
		$this->posted['payment_method']            = isset( $_POST['payment_method'] ) ? stripslashes( $_POST['payment_method'] ) : '';
		$this->posted['shipping_method']           = isset( $_POST['shipping_method'] ) ? $_POST['shipping_method'] : '';
		$this->posted['ship_to_different_address'] = isset( $_POST['ship_to_different_address'] ) &&  $_POST['ship_to_different_address']  ? true : false;
