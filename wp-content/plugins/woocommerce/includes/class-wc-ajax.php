...
class WC_AJAX {
	...
	public static function init() {
        ...
        public static function cart_header_html(){ 
	...
	public static function add_to_cart() {
		...
		if ( $passed_validation && WC()->cart->add_to_cart( $product_id, $quantity ) ) {
			...
			//self::get_refreshed_fragments();
                        ...
                        wp_send_json(['error'=>false,'html'=>$cart_html,'count'=> sprintf(_n('bag (%d)', 'bag (%d) - ', WC()->cart->cart_contents_count, 'esell'), WC()->cart->cart_contents_count) ]);
